...
<Section>
	<Container>
		<div class="mb-28 flex justify-between px-20">
			<div class="flex flex-col gap-2.5">
				<Paragraph classes="font-audiowide text-4xl">Графік роботи</Paragraph>
				<Text classes="text-2xl">ПН-НД 14:00 - 23:00</Text>
			</div>
			<div class="flex flex-col gap-2.5">
